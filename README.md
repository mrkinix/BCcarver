...
A fast, exact Hamiltonian cycle solver written in Rust. Built from first principles — the pruning rules were derived independently with pen and paper through experiment and intuition, then implemented with AI assistance. No prior knowledge of graph theory or Rust was assumed.
